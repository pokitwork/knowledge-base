---
name: leave
description: 포킷워크 연차/휴가 도메인. 연차 유형, 연차 정책(일수 계산), 부여형 휴가, 연차 신청, 휴직, 연차사용촉진의 엔티티 정의와 비즈니스 규칙. 연차/휴가 관련 기능 구현 시 참고한다.
---
...
- 회사별로 계산 방식(A 또는 B)을 선택한다
- 현재는 입사일 기준(A)만 사용 중이다
